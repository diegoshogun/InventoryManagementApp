...
public class ModifyProductController implements Initializable {
    ...
    /**
     * This method saves the newly updated product to the Observable List that holds all products.
     *
        ...
        try {
            ...
            if ((stock >= min && stock <= max) && (max > min) && !name.isEmpty()) {
                ...
                if (!associatedParts.isEmpty()) {
                    ...
                    System.out.println("associated parts is empty");
                }
    ...
    /**
     * This method cancels the update of the product and returns to the MainScreen.
     *
    ...
    /**
     * This method fills the text fields with original product data to update.
     *
     * @param product modifies product
     */
